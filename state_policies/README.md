...
| `hierarchy.csv` | Region hierarchy from ReEDS `main` at tag `2026.04.17` (commit `62f6381ec3da9005f0d7520dd37db235fc4c8784`), used to map BAs to states for the hydrofrac calculation. |
| `gen_ann.csv` | Annual generation by tech and BA from ReEDS `main` at tag `2026.04.17` (commit `62f6381ec3da9005f0d7520dd37db235fc4c8784`), used to compute hydro / non-RE shares for the hydrofrac calculation. |
