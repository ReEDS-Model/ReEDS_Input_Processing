...
input_file = "//nrelnas01/ReEDS/Supply_Curve_Data/LOAD/2020_Update/plexos_to_reeds/h5_2007-2014_ungrown_2012_1hr_EST.csv" #TODO: move to zenodo
...
#using an absolute MW difference in addition to 50% change
#df_diff = df.diff()
